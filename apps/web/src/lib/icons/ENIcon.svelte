...
<svg {width} {height} viewBox="0 0 513 343" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_301_1200)">
    <path d="M0 0.926514H513V342.93H0V0.926514Z" fill="white" />
    <path d="M288.562 0.923584H224.438V139.86H0V203.985H224.438V342.922H288.562V203.985H513V139.86H288.562V0.923584Z"
          fill="#D80027" />
    <path
    ...
    <path d="M90.5174 231.399L0 281.687V231.399H90.5174ZM200.739 245.58V342.921H25.5408L200.739 245.58Z"
          fill="#0052B4" />
    ...
    <path d="M422.483 112.447L513 62.1589V112.447H422.483ZM312.261 98.2653V0.924561H487.459L312.261 98.2653Z"
          fill="#0052B4" />
