	...
	<details name="Buildings">
		...
		<div class="step-content">
			<fieldset class="details"
				...
				<label for="typeOfUse">
					Gebruiksdoel
					<select bind:value={typeOfUseSum}
					        id="typeOfUse">
				...
				<label for="description">
					Omschrijving
					<textarea bind:value={descriptionSum}
					          cols="50"
					          id="description"
					          name="description"
					          rows="4"></textarea>
	...
	<details name="Buildings">
		...
		<div class="step-content">
			<fieldset class="timeline"
				...
				{/each}
					<Button on:click={addTimelineEntry}
					        size="content"
					        subtle>+ Voeg tijdlijn toe</Button>
			</fieldset>

			<div class="hidden">
				<input bind:value={bagID}
				       id="nummeraanduidingIdentificatie"
